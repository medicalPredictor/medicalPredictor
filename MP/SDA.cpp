...
int SDA::fillOutput(vector<int> &output, bool printToo, ostream &outStrm) {
    if (initChar < 0) {
...
int SDA::printSDA(ostream &outStrm = cout) {
    if (initChar < 0) {
